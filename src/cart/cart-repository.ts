 ...
 * TODO: back with Postgres (processed_requests, cart_snapshots, voice_order_confirmations).
 */
export class CartRepository {
  ...
  async saveSnapshot(cart: Cart): Promise<void> {
    // TODO: INSERT INTO cart_snapshots (cart_id, version, snapshot).
  ...
  async confirmOrder(cart: Cart): Promise<PosOrderId> {
    void this.db;
    // TODO: create pos_order / pos_order_line in Odoo; record voice_order_confirmations.
